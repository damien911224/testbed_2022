...
from rand_augmentation import RandAugmentFixed
        ...
        with tf.Session() as session:
            ...
            for epoch in range(1, self.epochs + 1, 1):
                ...
                while True:
                    ...
                    try:
                        frame_vectors = session.run(self.train_next_element)
        ...
        class Train():
            ...
            def sample(self, video):
                ...
                for frame_index in target_frames:
                    if crop_t_01 + crop_t_m_01 * crop_t_d_01 < 0 or \
                            crop_t_01 + crop_t_m_01 * crop_t_d_01 > total_crop_height:
                        crop_t_d_01 *= -1.0
